...
import ViewPaySlipItem from './ViewPaySlipItem';
import { salaryDistribution } from 'views/utilities/NeedyFunction';

const ViewPaySlipRow = ({ data, year, month }) => {
          ...
          <TableRow>
            <StyledTableCellWithNarrowBorder sx={{ width: '50%' }} colSpan={2}>
              ...
              <ViewPaySlipItem
                ...
                sx={{ mb: 0.5 }}
              />
              <ViewPaySlipItem title="Joining Date" value={data?.joiningDate} />
            </StyledTableCellWithNarrowBorder>
            <StyledTableCellWithNarrowBorder
              sx={{ width: '50%' }}
              colSpan={2}
