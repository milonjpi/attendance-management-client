...
const Guards = () => {
  ...
  return (
    ...
    >
      ...
      <AddGuard open={open} handleClose={() => setOpen(false)} />
      {/* end popup items */}
        ...
        <Table sx={{ minWidth: 400 }}>
          <TableHead>
            <StyledTableRow>
              ...
              <StyledTableCell align="center">Guard Photo</StyledTableCell>
          ...
          <TableBody>
            {filterData?.length ? (
              filterData
                ...
                .map((item) => <GuardRow key={item.id} sn={sn++} data={item} />)
            ) : (
              <StyledTableRow>
