...
import { useCreateSalaryMutation } from 'store/api/salary/salaryApi';
...
const AddSalaryRecord = ({ open, handleClose, employeeData }) => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      const res = await createSalary({ ...newData }).unwrap();
      if (res.success) {
        handleClose();
        reset();
        setStartDate(null);
