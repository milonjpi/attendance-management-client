...
import { useCreateGeoAttendanceMutation } from 'store/api/attendance/attendanceApi';
...
const MarkAttendance = ({ open, handleClose, employeeData, location }) => {
        ...
        >
          <Grid container spacing={3}>
            <Grid item xs={12}>
              <TextField
                fullWidth
                label="Late Note/Additional Note"
                size="small"
                {...register('remarks')}
              />
            </Grid>
            <Grid item xs={12}>
              <LoadingButton
                ...
                type="submit"
              >
                <span style={{ lineHeight: 1 }}>Mark Attendance</span>
              </LoadingButton>
            </Grid>
          </Grid>
        </Box>
